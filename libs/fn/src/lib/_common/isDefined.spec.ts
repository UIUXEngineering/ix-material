...
describe('isDefined', () => {
  ...
  it('should pass with _string with spaces', () => {
    const value = '   ';
    expect(isDefined(value)).toBe(true);
  });

  it('should pass with _number greather than 0', () => {
    const value = 1;
    expect(isDefined(value)).toBe(true);
  });

  it('should pass with _number 0', () => {
    const value = 0;
    expect(isDefined(value)).toBe(true);
  });
  ...
  it('should pass with empty _object', () => {
    const value: any = {};
    expect(isDefined(value)).toBe(true);
  });
  ...
  it('should pAA with empty _string', () => {
    const value = '';
    expect(isDefined(value)).toBe(true);
  });
