...
describe('Object', () => {
  ...
  describe('isTruthyIn', function() {
    ...
    it('returns true with filled _string', function() {
      expect(isTruthyIn(object, 'foo.bar.baz')).toBeTruthy();
    });

    it('returns false with empty _string', function() {
    ...
    it('returns true with true with _object that has props', function() {
      expect(isTruthyIn(object, 'foo.bar.bee')).toBeTruthy();
    });

    it('returns false with false with _object with no props', function() {
    ...
    describe('arrays', () => {
      ...
      it('should not accept _string as index', function() {
