...
describe('deleteIn', () => {
  describe('object', () => {
    ...
    it('should delete nested _object with dot notation', () => {
      // expected
      const expected = {
        a: 'a',
        b: {
  ...
  describe('array', () => {
    ...
    it('should delete nested _object in _array', () => {
      const expected: any = [
        {
          a: 'a',
          b: {
    ...
    it('should delete nested _array in an _object', () => {
      const expected: any = [
        {
          a: 'a',
          b: {
