...
import { splitKeysIntoDotNotation, isArraySyntax, keySplitterIntoImmutablePath } from './key-converter';
...
describe('_internal', () => {
  ...
  describe('isArraySyntax', () => {
    it('should test if array syntax true', () => {
    ...
    it('should test if array syntax false', () => {
