...
import { CDK, GIT_REPO_PROJECTS_BASE } from '../../../../../configs/constants';
...
export class StoreSubjectComponent implements OnInit {
  ...
  actionSpec = `${GIT_REPO_PROJECTS_BASE}/${CDK}/store/src/store-subject.action.spec.ts`;
  behaviorSpec = `${GIT_REPO_PROJECTS_BASE}/${CDK}/store/src/store-subject.behavior.spec.ts`;
  composeSpec = `${GIT_REPO_PROJECTS_BASE}/${CDK}/store/src/store-subject.compose.spec.ts`;
