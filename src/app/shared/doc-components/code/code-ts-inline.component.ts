...
@Component({
  // tslint:disable-next-line
  selector: 'code-ts-inline',
  template: `<span class="code-ts-inline"><pre><code
               class="typescript">{{code}}</code></pre></span>`,
  styleUrls: ['./code-ts-inline.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class CodeTsInlineComponent implements AfterViewInit, OnChanges {
