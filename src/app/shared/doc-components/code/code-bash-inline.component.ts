...
@Component({
  // tslint:disable
  selector: 'code-bash-inline',
  template: `<span class="code-bash-inline"><pre><code class="bash">{{code}}</code></pre></span>`,
  styleUrls: ['./code-bash-inline.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class CodeBashInlineComponent implements AfterViewInit, OnChanges {
