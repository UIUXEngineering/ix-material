    ...
    function(a, b, c) {
      ...
      (f.version = '1.20.2'),
        ...
        (k.render = function(a, b, d) {
            ...
            (a >= p - 1e-7 && a >= 0
              ? ((this._totalTime = p),
                ...
                0 === t &&
                  ...
                  (0 > u || (0 >= a && a >= -1e-7) || (u === g && 'isPause' !== this.data)) &&
                    u !== a &&
              ...
              ? ((this._totalTime = this._time = this._cycle = 0),
                ...
                0 > a &&
                  ...
                  0 === t &&
                    (this._initted || !this.vars.lazy || d) &&
                    (u >= 0 && (d = !0), (this._rawPrevTime = n = !b || a || u === a ? a : g))),
                this._initted || (d = !0))
          ...
          for (
            this._lazy !== !1 && (this._lazy = !1),
              ...
              0 === r &&
                ...
                this._startAt && (a >= 0 ? this._startAt.render(a, b, d) : f || (f = '_dummyGS')),
          ...
          this._onUpdate &&
            (0 > a && this._startAt && this._startTime && this._startAt.render(a, b, d),
            b || ((this._totalTime !== r || f) && this._callback('onUpdate'))),
            this._cycle !== s && (b || this._gc || (this.vars.onRepeat && this._callback('onRepeat'))),
            f &&
              (!this._gc || d) &&
              (0 > a && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(a, b, d),
        ...
        (f.fromTo = function(a, b, c, d) {
          return (
            (d.startAt = c), (d.immediateRender = 0 != d.immediateRender && 0 != c.immediateRender), new f(a, b, d)
          );
        }),
      ...
      function(a, b, c) {
        ...
        return (
          ...
          (q._parseTimeOrLabel = function(b, c, d, e) {
            ...
            if (
              ((f = this.duration() > 99999999999 ? this.recent().endTime(!1) : this._duration), 'string' == typeof c)
            )
          ...
          (q.render = function(a, b, c) {
            ...
            if ((this._time !== o && this._first) || c || i || l) {
              if (
                ...
                0 === o &&
                  this.vars.onStart &&
                  ((0 === this._time && this._duration) || b || this._callback('onStart')),
                (m = this._time),
                m >= o)
              )
          ...
          (k.render = function(a, b, c) {
            ...
            if (this._cycle !== w && !this._locked) {
              ...
              if (
                ...
                b ||
                  this._gc ||
                  (this.vars.onRepeat && ((this._cycle = A), (this._locked = !1), this._callback('onRepeat'))),
                q !== this._time)
              )
                return;
              if (
                (y && ((this._cycle = w), (this._locked = !0), (q = x ? p + 1e-4 : -1e-4), this.render(q, !0, !1)),
                (this._locked = !1),
                this._paused && !v)
              )
                return;
        ...
        (pa = new RegExp(pa + ')', 'gi')),
          (g.colorStringFilter = function(a) {
            var b,
              c = a[0] + ' ' + a[1];
            pa.test(c) &&
              ((b = -1 !== c.indexOf('hsl(') || -1 !== c.indexOf('hsla(')), (a[0] = oa(a[0], b)), (a[1] = oa(a[1], b))),
              (pa.lastIndex = 0);
          }),
        ...
        var qa = function(a, b, c, d) {
          ...
          sa =
            ((S._setPluginRatio = function(a) {
              ...
              if (
                (g.autoRotate && (g.autoRotate.rotation = g.mod ? g.mod(h.rotation, this.t) : h.rotation),
                1 === a || 0 === a)
              )
                ...
                ? (g.l++,
                  ...
                  h > 0
                    ? ((g.data['xn' + h] = b + c),
                      ...
                      (g['xn' + h] = b),
                      g.plugin ||
                        ((g.xfirst = new ta(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)), (g.xfirst.xs0 = 0)),
                      g)
        ...
        var Aa,
          ...
          Ra = (S.getTransform = function(a, c, d, e) {
            ...
            if (
              ((m.svg = !(!a.getCTM || !Oa(a))),
              m.svg &&
                (La(a, _(a, Ea, c, !1, '50% 50%') + '', m, a.getAttribute('data-svg-origin')),
              ...
              if (
                ...
                for (
                  ...
                  (z = fa[wa]),
                    ...
                    (A =
                      c !== d[z] ? (2 > wa ? -d.ieOffsetX : -d.ieOffsetY) : 2 > wa ? n - d.ieOffsetX : o - d.ieOffsetY),
                ...
                ? ((B *= K),
                  ...
                  L &&
                    ...
                    Aa &&
                      ...
                      ((q = this.t.getBBox()), (H += 0.01 * z.xPercent * q.width), (I += 0.01 * z.yPercent * q.height)),
                    (q = 1e-6),
                    q > H && H > -q && (H = 0),
                    q > I && I > -q && (I = 0)),
                  (u =
            ...
            (k = 1),
              ...
              C || D || 1 !== G
                ? ((u += v + (q > j && j > -q ? w : j) + v + (q > m && m > -q ? w : m) + v + (q > e && e > -q ? w : e)),
                  (u +=
                    v + (q > h && h > -q ? w : h) + v + (q > k && k > -q ? w : k) + v + (q > o && o > -q ? w : o) + v))
                : (u += ',0,0,0,0,1,0,'),
                ...
                if (
                  ...
                  (m = Q.style),
                    ...
                    D.svg &&
                      ...
                      (s || t) &&
                        ((u = Qa(Q, !0)), (l.x -= s - (s * u[0] + t * u[2])), (l.y -= t - (s * u[1] + t * u[3])))),
            ...
            parser: function(a, b, c, d, f, g) {
              ...
              return (
                ...
                this.parseComplex(
                  a.style,
                  this.format(
                    h + ' ' + _(a, 'borderTopStyle', e, !1, 'solid') + ' ' + _(a, 'borderTopColor', e, !1, '#000')
                  ),
                  i.join(' '),
                  f,
                  g
        ...
        (j = g.prototype),
          ...
          (j._onInitTween = function(a, b, h, j) {
            ...
            if (
              (l &&
                '' === A.zIndex &&
                ((n = _(a, 'zIndex', e)), ('auto' === n || '' === n) && this._addLazySet(A, 'zIndex', 0)),
              'string' == typeof b &&
                ((t = A.cssText),
                (n = ca(a, e)),
                (A.cssText = t + ';' + b),
                ...
                z = 3 === this._transformType,
                  Ca
                    ? m &&
                      ((l = !0),
                      '' === A.zIndex &&
                        ((w = _(a, 'zIndex', e)), ('auto' === w || '' === w) && this._addLazySet(A, 'zIndex', 0)),
                      o &&
                        this._addLazySet(
                          A,
          ...
          (j.parse = function(a, b, c, f) {
            var g,
              ...
              u = a.style;
            for (g in b) {
              if (((n = b[g]), 'function' == typeof n && (n = n(r, q)), (h = i[g])))
                ...
                (m = _(a, g, e) + ''),
                  ...
                  'color' === g || 'fill' === g || 'stroke' === g || -1 !== g.indexOf('Color') || (s && A.test(n))
                    ? (s || ((n = na(n)), (n = (n.length > 3 ? 'rgba(' : 'rgb(') + n.join(',') + ')')),
                    ...
                    : ((j = parseFloat(m)),
                      ...
                      (!j && 0 !== j) || (!l && 0 !== l)
                        ...
                        : ((c = new ta(u, g, j, l - j, c, 0, g, k !== !1 && ('px' === p || 'zIndex' === g), 0, m, n)),
                          (c.xs0 = p)));
              }
    ...
    if (!e.TweenLite) {
                    ...
                    ? 'string' != typeof f
                      ? f.length && f !== a && f[0] && (f[0] === a || (f[0].nodeType && f[0].style && !f.nodeType))
                        ...
                        : ((this._siblings[e] = $(f, this, !1)),
                          1 === i && this._siblings[e].length > 1 && aa(f, this, null, 1, this._siblings[e]))
      ...
      var J = [],
        ...
        N = function(a) {
          for (var b, c = this._firstPT, d = 1e-6; c; )
            (b = c.blob ? (1 === a && this.end ? this.end : a ? this.join('') : this.start) : c.c * a + c.s),
      ...
      var $ = function(a, b, c) {
          var d,
            ...
            f = a._gsTweenID;
          if (
            (S[f || (a._gsTweenID = f = 't' + T++)] || (S[f] = { target: a, tweens: [] }),
            ...
            (h = e[f]) === b ||
              ...
              (h._timeline !== b._timeline
                ...
                : h._startTime <= k &&
                  ...
                  (((o || !h._initted) && k - h._startTime <= 2e-10) || (l[n++] = h)));
          for (f = n; --f > -1; )
          ...
          if (a >= i - 1e-7 && a >= 0)
            (this._totalTime = this._time = i),
              ...
              0 === i &&
                ...
                (this._startTime === this._timeline._duration && (a = 0),
                (0 > j || (0 >= a && a >= -1e-7) || (j === m && 'isPause' !== this.data)) &&
                  j !== a &&
          ...
          if (this._time !== h || c) {
            if (!this._initted) {
              ...
              if (
                ...
                return (
                  (this._time = this._totalTime = h), (this._rawPrevTime = j), J.push(this), void (this._lazy = [a, b])
                );
              this._time && !d
