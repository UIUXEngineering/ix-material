...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function(a, b, c) {
      var d,
        ...
        aa = function(a) {
          return a
            ? ('string' == typeof a && (a = b.selector(a)),
              a.length && a !== window && a[0] && a[0].style && !a.nodeType && (a = a[0]),
        ...
        ba = function(a, b) {
          ...
          if (void 0 === g[b]) {
            for (
              f = ['O', 'Moz', 'ms', 'Ms', 'Webkit'], e = 5, c = b.charAt(0).toUpperCase() + b.substr(1);
              --e > -1 && void 0 === g[f[e] + c];
        ...
        ga = function(a, b, c, d, e) {
          ...
          return (
            ...
            '%' === d && -1 !== b.indexOf('border')
              ...
              : ((i.cssText = 'border:0 solid red;position:' + ia(a, 'position', !0) + ';line-height:0;'),
                '%' !== d && h.appendChild
        ...
        ia = function(a, b, c) {
          ...
          return e || 0 === e
            ...
            : (a.style[b]
                ? (e = a.style[b])
                : (d = da(a))
                ? ((e = d.getPropertyValue(b.replace(/([A-Z])/g, '-$1').toLowerCase())), (e = e || d.length ? e : d[b]))
        ...
        ja = function(a, b, c) {
          var d = a.vars,
            ...
            f = a._listeners[b];
          'function' == typeof e &&
            e.apply(d[c + 'Scope'] || d.callbackScope || a, d[c + 'Params'] || [a.pointerEvent]),
            f && a.dispatchEvent(b);
        },
        ka = function(a, b) {
          var c,
          ...
          return f
            ? Ea(f, b)
            : void 0 !== a.left
            ? ((e = ya(b)), { left: a.left - e.x, top: a.top - e.y, width: a.width, height: a.height })
        ...
        xa = function(a) {
          if (!a.getBoundingClientRect || !a.parentNode || !oa)
            return { offsetTop: 0, offsetLeft: 0, scaleX: 1, scaleY: 1, offsetParent: u };
          ...
          for (
            e = s.offsetParent, e === t.body && (e = u), wa.length = va.length = 0;
            r &&
            ((j = ia(r, oa, !0)),
          ...
          for (
            d = e.getBoundingClientRect(),
              ...
              s.borderBox &&
                ...
                (s.scaleY *= (q - o) / q)),
              i
                ? ((c = a.getBoundingClientRect()), (s.offsetLeft = c.left - d.left), (s.offsetTop = c.top - d.top))
        ...
        ya = function(a, c) {
          if (((c = c || {}), !a || a === u || !a.parentNode || a === window)) return { x: 0, y: 0 };
          var d = da(a),
          ...
          return (
            ...
            a.getBBox && ta(a)
              ? (a._gsTransform ||
                  ...
                  void 0 === a._gsTransform.xOrigin && console.log('Draggable requires at least GSAP 1.17.0')),
                (e = a.getBBox()),
                (c.x = a._gsTransform.xOrigin - e.x),
                (c.y = a._gsTransform.yOrigin - e.y))
              : (a.getBBox &&
                  -1 !== (g + h).indexOf('%') &&
                  ((a = a.getBBox()), (a = { offsetWidth: a.width, offsetHeight: a.height })),
        ...
        za = function(a) {
          ...
          if (
            ((d.isSVG = f), (d.isSVGRoot = g), (d.borderBox = 'border-box' === e.boxSizing), (d.computedStyle = e), g)
          )
        ...
        Aa = function(a, b, c, d, e) {
          ...
          return (
            (f =
              y.isSVG && -1 !== (a.style[oa] + '').indexOf('matrix')
                ? a.style[oa]
                : B
                ? B.getPropertyValue(pa)
                : a.currentStyle
                ? a.currentStyle[oa]
                : '1,0,0,1,0,0'),
            a.getBBox &&
            ...
            (f = (f + '').match(/(?:\-|\.|\b)(\d|\.|e\-)+/g) || [1, 0, 0, 1, 0, 0]),
            f.length > 6 && (f = [f[0], f[1], f[4], f[5], f[12], f[13]]),
            d
              ? (f[4] = f[5] = 0)
              : y.isSVG &&
                (m = a._gsTransform) &&
                ...
                (f[2] = parseFloat(f[2])),
                (f[3] = parseFloat(f[3])),
                (f[4] = parseFloat(f[4]) - (m.xOrigin - (m.xOrigin * f[0] + m.yOrigin * f[2]))),
                (f[5] = parseFloat(f[5]) - (m.yOrigin - (m.xOrigin * f[1] + m.yOrigin * f[3])))),
            b &&
              (void 0 === g && la(),
              (i = y.isSVG || y.isSVGRoot ? xa(a) : a),
              y.isSVG
                ? ((l = a.getBBox()),
                  (r = A.isSVGRoot ? { x: 0, y: 0 } : z.getBBox()),
                  (i = { offsetLeft: l.x - r.x, offsetTop: l.y - r.y, offsetParent: y.offsetParent }))
                : y.isSVGRoot
                ? ((s = parseInt(B.borderTopWidth, 10) || 0),
                  (v = parseInt(B.borderLeftWidth, 10) || 0),
                  (w = (f[0] - g) * v + f[2] * s),
                  (x = f[1] * v + (f[3] - g) * s),
                  (n = b.x),
                  (o = b.y),
                  (p = n - (n * f[0] + o * f[2])),
                  (q = o - (n * f[1] + o * f[3])),
                  (f[4] = parseFloat(f[4]) + p),
                  (f[5] = parseFloat(f[5]) + q),
                  (b.x -= p),
                  (b.y -= q),
                  (n = i.scaleX),
                  (o = i.scaleY),
                  ...
                  (f[3] *= o),
                  ua || ((b.x += w), (b.y += x)),
                  C === t.body && i.offsetParent === u && (C = u))
                : !j &&
                  a.offsetParent &&
                  ((b.x += parseInt(ia(a.offsetParent, 'borderLeftWidth'), 10) || 0),
                  (b.y += parseInt(ia(a.offsetParent, 'borderTopWidth'), 10) || 0)),
              (h = z === u || z === t.body),
              (f[4] = Number(f[4]) + b.x + (i.offsetLeft || 0) - c.x - (h ? 0 : z.scrollLeft || 0)),
              (f[5] = Number(f[5]) + b.y + (i.offsetTop || 0) - c.y - (h ? 0 : z.scrollTop || 0)),
              z && 'fixed' === ia(a, 'position', B) && ((f[4] += V()), (f[5] += U())),
              !z ||
                z === u ||
                C !== i.offsetParent ||
                A.isSVG ||
                (k && '100100' !== Aa(z).join('')) ||
                ((i = A.isSVGRoot ? xa(z) : z),
                (f[4] -= i.offsetLeft || 0),
                (f[5] -= i.offsetTop || 0),
                j ||
                  !A.offsetParent ||
                  y.isSVG ||
                  y.isSVGRoot ||
                  ((f[4] -= parseInt(ia(A.offsetParent, 'borderLeftWidth'), 10) || 0),
                  (f[5] -= parseInt(ia(A.offsetParent, 'borderTopWidth'), 10) || 0)))),
            f
          );
        },
        Ba = function(a, b) {
          ...
          for (
            var c, d, e, f, g, h, i, j, k = ya(a, qa), l = ya(a.parentNode, ra), m = Aa(a, k, l, !1, !0);
        ...
        Ea = function(a, b, c) {
          ...
          if (a === window)
            (g = U()),
              (e = V()),
              (f = e + (u.clientWidth || a.innerWidth || t.body.clientWidth || 0)),
              (h =
                g +
            ...
            (d = ya(a)),
              ...
              B
                ...
                : ((z = da(a)), (p = parseFloat(z.width)), (q = parseFloat(z.height))),
              (f = e + p),
              (h = g + q),
        ...
        Ga = function(a) {
          var b,
            ...
            f = a.length;
          for (b = 0; f > b; b++)
            if (((c = a[b]), Fa(c))) for (d = c.length, d = 0; d < c.length; d++) e.push(c[d]);
        ...
        Pa = function(a) {
          ...
          return a && a.getAttribute && 'BODY' !== a.nodeName
            ? 'true' === (b = a.getAttribute('data-clickable')) ||
              ('false' !== b && (a.onclick || H.test(a.nodeName + '') || 'true' === a.getAttribute('contentEditable')))
              ? !0
              : Pa(a.parentNode)
            : !1;
        },
        ...
        Sa = function(a, c) {
          ...
          var d,
            ...
            v = 0,
            w = 0;
          ma && c.force3D !== !1 ? ((h = 'translate3d('), (i = 'px,0px)')) : oa && ((h = 'translate('), (i = 'px)')),
            ...
            (this.left = function(d, e) {
              ...
              return (f > 2 || -2 > f) && !e
                ...
                : ((d = -d),
                  ...
                  (o || g) &&
                    (h ? this._suspendTransforms || (k[oa] = h + -o + 'px,' + -n + i) : (k.left = -o + 'px'),
            ...
            (this.top = function(d, e) {
              ...
              return (f > 2 || -2 > f) && !e
                ...
                : ((d = -d),
                  ...
                  (n || g) && (h ? this._suspendTransforms || (k[oa] = h + -o + 'px,' + -n + i) : (k.top = -n + 'px')),
                  (a.scrollTop = 0 | d),
                  void (p = a.scrollTop));
            }),
              ...
              (p = a.scrollTop),
                ...
                (!h ||
                  ...
                  (!h || b) &&
                    ...
                    u && (u += ia(a, 'paddingLeft') + (l ? ia(a, 'paddingRight') : 0))),
        ...
        Ta = function(d, g) {
          ...
          var h,
            ...
            va,
            wa,
            xa = (g.type || (C ? 'top,left' : 'x,y')).toLowerCase(),
                  ...
                  Wa = !1,
                    ...
                    M.scrollLeft =
                      null != window.pageXOffset
                        ...
                        ? u.scrollLeft
                        : t.body.scrollLeft,
                    f = Ma.pointerX - M.scrollLeft,
                    g = Ma.pointerY - M.scrollTop;
                  l && !c;
                  ...
                  (c = Y(l.parentNode)),
                    ...
                    Fa &&
                      ...
                      0 > k
                        ? (j = k)
                        : g > e.bottom - 40 && k
                        ? ((Wa = !0), (j = Math.min(k, (m * (1 - Math.max(0, e.bottom - g) / 40)) | 0)))
                        : g < e.top + 40 &&
                          b.scrollTop &&
                          ((Wa = !0), (j = -Math.min(b.scrollTop, (m * (1 - Math.max(0, g - e.top) / 40)) | 0))),
                      j && (b.scrollTop += j)),
                    Ea &&
                      ...
                      0 > k
                        ? (h = k)
                        : f > e.right - 40 && k
                        ? ((Wa = !0), (h = Math.min(k, (m * (1 - Math.max(0, e.right - f) / 40)) | 0)))
                        : f < e.left + 40 &&
                          b.scrollLeft &&
                          ((Wa = !0), (h = -Math.min(b.scrollLeft, (m * (1 - Math.max(0, f - e.left) / 40)) | 0))),
                      h && (b.scrollLeft += h)),
                    c && (h || j) && (window.scrollTo(b.scrollLeft, b.scrollTop), nb(Ma.pointerX + h, Ma.pointerY + j)),
                    (l = b);
              }
              if (ba) {
                var n = Ma.x,
                ...
                p > n && n > -p && (n = 0),
                  p > o && o > -p && (o = 0),
                  za
                    ? ((Ma.deltaX = n - qa.data.rotation), (qa.data.rotation = Ma.rotation = n), qa.setRatio(1))
                    : i
                    ? (Fa && ((Ma.deltaY = o - i.top()), i.top(o)), Ea && ((Ma.deltaX = n - i.left()), i.left(n)))
                    : ya
                    ? (Fa && ((Ma.deltaY = o - qa.data.y), (qa.data.y = o)),
                      Ea && ((Ma.deltaX = n - qa.data.x), (qa.data.x = n)),
                      qa.setRatio(1))
                    : (Fa && ((Ma.deltaY = o - parseFloat(d.style.top || 0)), (d.style.top = o + 'px')),
                      Ea && ((Ma.deltaY = n - parseFloat(d.style.left || 0)), (d.style.left = n + 'px'))),
                  !v || a || ua || ((ua = !0), ja(Ma, 'drag', 'onDrag'), (ua = !1));
              }
              ba = !1;
            },
            ab = function(a, c) {
              var e,
                f = Ma.x,
                g = Ma.y;
              d._gsTransform || (!ya && !za) || b.set(d, { x: '+=0', overwrite: !1 }),
                ya
                  ? ((Ma.y = d._gsTransform.y), (Ma.x = d._gsTransform.x))
                  : za
                  ? (Ma.x = Ma.rotation = d._gsTransform.rotation)
                  : i
                  ? ((Ma.y = i.top()), (Ma.x = i.left()))
                  : ((Ma.y = parseInt(d.style.top, 10) || 0), (Ma.x = parseInt(d.style.left, 10) || 0)),
                (ea || fa || ga) &&
                  !c &&
                  (Ma.isDragging || Ma.isThrowing) &&
                  (ga &&
                    ((L.x = Ma.x),
                    (L.y = Ma.y),
                    (e = ga(L)),
                    e.x !== Ma.x && ((Ma.x = e.x), (ba = !0)),
                    e.y !== Ma.y && ((Ma.y = e.y), (ba = !0))),
                  ea && ((e = ea(Ma.x)), e !== Ma.x && ((Ma.x = e), za && (Ma.rotation = e), (ba = !0))),
                  fa && ((e = fa(Ma.y)), e !== Ma.y && (Ma.y = e), (ba = !0))),
                ba && _a(!0),
                a || ((Ma.deltaX = Ma.x - f), (Ma.deltaY = Ma.y - g), ja(Ma, 'throwupdate', 'onThrowUpdate'));
            },
            bb = function() {
              var a, b, c, e;
              (s = !1),
                i
                  ? (i.calibrate(),
                    (Ma.minX = y = -i.maxScrollLeft()),
                    (Ma.minY = H = -i.maxScrollTop()),
                    (Ma.maxX = w = Ma.maxY = E = 0),
                    (s = !0))
                  : g.bounds &&
                    ((a = ka(g.bounds, d.parentNode)),
                    za
                      ? ((Ma.minX = y = a.left), (Ma.maxX = w = a.left + a.width), (Ma.minY = H = Ma.maxY = E = 0))
                      ...
                      ? ((a = g.bounds),
                        ...
                        (Ma.maxY = E = a.maxY))
                      : ((b = ka(d, d.parentNode)),
                        (Ma.minX = y = ia(d, Aa) + a.left - b.left),
                        (Ma.minY = H = ia(d, Da) + a.top - b.top),
                        (Ma.maxX = w = y + (a.width - b.width)),
                        (Ma.maxY = E = H + (a.height - b.height))),
                    y > w && ((Ma.minX = w), (Ma.maxX = w = y), (y = Ma.minX)),
                    H > E && ((Ma.minY = E), (Ma.maxY = E = H), (H = Ma.minY)),
                    za && ((Ma.minRotation = y), (Ma.maxRotation = w)),
                    (s = !0)),
                g.liveSnap &&
                  ((c = g.liveSnap === !0 ? g.snap || {} : g.liveSnap),
                  (e = c instanceof Array || 'function' == typeof c),
                  za
                    ? ((ea = jb(e ? c : c.rotation, y, w, 1)), (fa = null))
                    : c.points
                    ? (ga = kb(e ? c : c.points, y, w, H, E, c.radius, i ? -1 : 1))
                    : (Ea && (ea = jb(e ? c : c.x || c.left || c.scrollLeft, y, w, i ? -1 : 1)),
                      Fa && (fa = jb(e ? c : c.y || c.top || c.scrollTop, H, E, i ? -1 : 1))));
            },
            cb = function() {
            ...
            eb = function(a, b) {
              ...
              a && f
                ? (a === !0 &&
                    ((c = g.snap || g.liveSnap || {}),
                    (e = c instanceof Array || 'function' == typeof c),
                    (a = { resistance: (g.throwResistance || g.resistance || 1e3) / (za ? 10 : 1) }),
                    za
                      ? (a.rotation = Oa(Ma, e ? c : c.rotation, w, y, 1, b))
                      : (Ea &&
                          (a[Aa] = Oa(
                            Ma,
                        ...
                        (c.points || (c instanceof Array && 'object' == typeof c[0])) &&
                          ((a.linkedProps = Aa + ',' + Da), (a.radius = c.radius)))),
                  (Ma.isThrowing = !0),
                  (j = isNaN(g.overshootTolerance)
                    ? 1 === g.edgeResistance
                      ? 0
                      : 1 - Ma.edgeResistance + 0.2
                  ...
                  (Ma.tween = h = f.to(
                    i || d,
                    {
                      ...
                      onUpdateParams: g.fastMode
                        ? [Ma, 'onthrowupdate', 'onThrowUpdate']
                        : c && c.radius
                        ? [!1, !0]
                        : x,
                    },
                    ...
                    isNaN(g.minDuration)
                      ? 0 === j || ('object' == typeof a && a.resistance > 1e3)
                        ? 0
                        : 0.5
                      : g.minDuration,
                    j
            ...
            fb = function(a) {
              ...
              (ma = Ba(d.parentNode, !0)),
                ...
                ma[1] || ma[2] || 1 != ma[0] || 1 != ma[3] || 0 != ma[4] || 0 != ma[5] || (ma = null);
            },
            gb = function() {
              var a = 1 - Ma.edgeResistance;
              fb(!1),
                ma &&
                  ((j = Ma.pointerX * ma[0] + Ma.pointerY * ma[2] + ma[4]),
                  (k = Ma.pointerX * ma[1] + Ma.pointerY * ma[3] + ma[5])),
                ba && (nb(Ma.pointerX, Ma.pointerY), _a(!0)),
                i
                  ? (bb(), (r = i.top()), (l = i.left()))
                  : (hb() ? (ab(!0, !0), bb()) : Ma.applyBounds(),
                    za
                      ? ((Z = Ma.rotationOrigin = Ca(d, { x: 0, y: 0 })),
                        ab(!0, !0),
                        (l = Ma.x),
                        (r = Ma.y = Math.atan2(Z.y - Ma.pointerY, Ma.pointerX - Z.x) * z))
                ...
                s &&
                  a &&
                  (l > w ? (l = w + (l - w) / a) : y > l && (l = y - (y - l) / a),
                  za || (r > E ? (r = E + (r - E) / a) : H > r && (r = H - (H - r) / a))),
                (Ma.startX = l),
                (Ma.startY = r);
            },
            hb = function() {
                ...
                'function' == typeof a
                  ? function(h) {
                      var i,
                        j,
                        k,
                        l = Ma.isPressed ? 1 - Ma.edgeResistance : 1,
                        m = h.x,
                        n = h.y;
                      return (
                        (h.x = m = m > c ? c + (m - c) * l : b > m ? b + (m - b) * l : m),
                        (h.y = n = n > e ? e + (n - e) * l : d > n ? d + (n - d) * l : n),
                        (i = a.call(Ma, h)),
                        i !== h && ((h.x = i.x), (h.y = i.y)),
                        1 !== g && ((h.x *= g), (h.y *= g)),
                        A > f && ((j = h.x - m), (k = h.y - n), j * j + k * k > f && ((h.x = m), (h.y = n))),
                        h
                      );
                    }
                  : a instanceof Array
                  ? function(b) {
                      for (var c, d, e, g, h = a.length, i = 0, j = A; --h > -1; )
            ...
            lb = function(a) {
              ...
              if (
                !(
                  ...
                  Ma.isPressed ||
                  !a ||
                  (('mousedown' === a.type || 'pointerdown' === a.type) && B() - Za < 30 && Ia[Ma.pointerEvent.type])
                )
              ) {
                if (
                  ((na = hb()),
                  (Ma.pointerEvent = a),
                  Ia[a.type]
                    ? ((la = -1 !== a.type.indexOf('touch') ? a.currentTarget || a.target : t),
                      Ja(la, 'touchend', ob),
                      Ja(la, 'touchmove', mb),
                      Ja(la, 'touchcancel', ob),
                      Ja(t, 'touchstart', Na))
                    : ((la = null), Ja(t, 'mousemove', mb)),
                  (sa = null),
                  Ja(t, 'mouseup', ob),
                  a && a.target && Ja(a.target, 'mouseup', ob),
                  (ha = Ya.call(Ma, a.target) && !g.dragClickables))
                )
                  return Ja(a.target, 'change', ob), ja(Ma, 'press', 'onPress'), void Qa(Ra, !0);
                if (
                  ((ra = la && Ea !== Fa && Ma.vars.allowNativeTouchScrolling !== !1 ? (Ea ? 'y' : 'x') : !1),
                  C
                    ? (a = _(a, !0))
                    : ra ||
                      Ma.allowEventDefault ||
                      (a.preventDefault(), a.preventManipulation && a.preventManipulation()),
                  a.changedTouches
                  ...
                  I++,
                  Q(_a),
                  (k = Ma.pointerY = a.pageY),
                  (j = Ma.pointerX = a.pageX),
                  (ra || Ma.autoScroll) && $(d.parentNode),
                  d.parentNode &&
                    (i || (Ma.autoScroll && !za && d.parentNode._gsMaxScrollX && !D.parentNode)) &&
                    !d.getBBox &&
                    ((D.style.width = d.parentNode.scrollWidth + 'px'), d.parentNode.appendChild(D)),
                  gb(),
                  Ma.tween && Ma.tween.kill(),
                  (Ma.isThrowing = !1),
                  b.killTweensOf(i || d, !0, Ua),
                  i && b.killTweensOf(d, !0, { scrollTo: 1 }),
                  (Ma.tween = Ma.lockedAxis = null),
                  (g.zIndexBoost || (!za && !i && g.zIndexBoost !== !1)) && (d.style.zIndex = Ta.zIndex++),
                  (Ma.isPressed = !0),
                  (v = !(!g.onDrag && !Ma._listeners.drag)),
                  !za)
                )
              ...
              if (h && !e && Ma.isPressed && a) {
                ...
                if (C) a = _(a, !0);
                  ...
                  if (
                    ...
                    ((c = a.pageX),
                    (d = a.pageY),
                    ma && ((f = c * ma[0] + d * ma[2] + ma[4]), (d = c * ma[1] + d * ma[3] + ma[5]), (c = f)),
                    (g = Math.abs(c - j)),
                    (i = Math.abs(d - k)),
                    ((g !== i && (g > Ga || i > Ga)) || (J && ra === sa)) &&
                      ((sa = g > i && Ea ? 'x' : 'y'),
                      Ma.vars.lockAxisOnTouchScroll !== !1 &&
                        ((Ma.lockedAxis = 'x' === sa ? 'y' : 'x'),
                        'function' == typeof Ma.vars.onLockAxis && Ma.vars.onLockAxis.call(Ma, l)),
                      J && ra === sa))
                  )
                    return void ob(l);
                  Ma.allowEventDefault ||
                    (ra && (!sa || ra === sa)) ||
                    l.cancelable === !1 ||
                    (l.preventDefault(), l.preventManipulation && l.preventManipulation());
                }
              ...
              (Ma.pointerX = a),
                ...
                za
                  ? ((f = Math.atan2(Z.y - b, a - Z.x) * z),
                    ...
                    (e = l + (r - f) * i))
                  : (ma && ((h = a * ma[0] + b * ma[2] + ma[4]), (b = a * ma[1] + b * ma[3] + ma[5]), (a = h)),
                    (d = b - k),
                    (c = a - j),
                    Ga > d && d > -Ga && (d = 0),
                    Ga > c && c > -Ga && (c = 0),
                    (Ma.lockAxis || Ma.lockedAxis) &&
                      (c || d) &&
                      ((h = Ma.lockedAxis),
                      h ||
                        ((Ma.lockedAxis = h = Ea && Math.abs(c) > Math.abs(d) ? 'y' : Fa ? 'x' : null),
                        h && 'function' == typeof Ma.vars.onLockAxis && Ma.vars.onLockAxis.call(Ma, Ma.pointerEvent)),
                      'y' === h ? (d = 0) : 'x' === h && (c = 0)),
                    (e = l + c * i),
                    (f = r + d * i)),
                (ea || fa || ga) && (Ma.x !== e || (Ma.y !== f && !za))
                  ? (ga && ((L.x = e), (L.y = f), (h = ga(L)), (e = h.x), (f = h.y)),
                    ea && (e = ea(e)),
                    fa && (f = fa(f)))
                  : s &&
                    (e > w ? (e = w + (e - w) * m) : y > e && (e = y + (e - y) * m),
                    za || (f > E ? (f = E + (f - E) * m) : H > f && (f = H + (f - H) * m))),
                za || ma || ((e = Math.round(e)), (f = Math.round(f))),
                (Ma.x !== e || (Ma.y !== f && !za)) &&
                  (za
                    ? ((Ma.endRotation = Ma.x = Ma.endX = e), (ba = !0))
                    : (Fa && ((Ma.y = Ma.endY = f), (ba = !0)), Ea && ((Ma.x = Ma.endX = e), (ba = !0))),
                  !Ma.isDragging && Ma.isPressed && ((Ma.isDragging = !0), ja(Ma, 'dragstart', 'onDragStart')));
            },
            ob = function(a, c) {
              if (
                h &&
                ...
                (!a ||
                  null == V ||
                  c ||
                  !((a.pointerId && a.pointerId !== V) || (a.changedTouches && !La(a.changedTouches, V))))
              ) {
                Ma.isPressed = !1;
                var e,
                  f,
                  ...
                  l = a,
                  m = Ma.isDragging,
                  n = b.delayedCall(0.001, ib);
                if (
                  (la
                    ? (Ka(la, 'touchend', ob),
                      Ka(la, 'touchmove', mb),
                      Ka(la, 'touchcancel', ob),
                      Ka(t, 'touchstart', Na))
                    : Ka(t, 'mousemove', mb),
                  Ka(t, 'mouseup', ob),
                  a && a.target && Ka(a.target, 'mouseup', ob),
                  (ba = !1),
                  ha)
                )
                  return (
                    a && Ka(a.target, 'change', ob),
                    Qa(Ra, !1),
                    ja(Ma, 'release', 'onRelease'),
                    ja(Ma, 'click', 'onClick'),
                    void (ha = !1)
                  );
                if ((R(_a), !za)) for (f = Ra.length; --f > -1; ) ca(Ra[f], 'cursor', g.cursor || 'move');
                ...
                return (
                  l && !m
                    ? (na && (g.snap || g.bounds) && eb(g.throwProps),
                      ja(Ma, 'release', 'onRelease'),
                      (J && 'touchmove' === l.type) ||
                        (ja(Ma, 'click', 'onClick'),
                            ...
                            (j.click
                              ...
                              : t.createEvent &&
                                ...
                                i.initMouseEvent(
                                  ...
                                  window,
                                  1,
                                  Ma.pointerEvent.screenX,
                                  Ma.pointerEvent.screenY,
                                  Ma.pointerX,
                                  Ma.pointerY,
                                  !1,
                                  !1,
                    ...
                    : (eb(g.throwProps),
                      C ||
                        Ma.allowEventDefault ||
                        !l ||
                        (!g.dragClickables && Ya.call(Ma, l.target)) ||
                        !m ||
                        (ra && (!sa || ra !== sa)) ||
                        l.cancelable === !1 ||
                        (l.preventDefault(), l.preventManipulation && l.preventManipulation()),
                      ja(Ma, 'release', 'onRelease')),
                  hb() && n.duration(Ma.tween.duration()),
                  m && ja(Ma, 'dragend', 'onDragEnd'),
                  !0
                );
              }
            },
            pb = function(a) {
              if (a && Ma.isDragging && !i) {
                ...
                (c || e) &&
                  (ma ? ((j -= c * ma[0] + e * ma[2]), (k -= e * ma[3] + c * ma[1])) : ((j -= c), (k -= e)),
                  (b._gsScrollX += c),
                  (b._gsScrollY += e),
                  nb(Ma.pointerX, Ma.pointerY));
              }
            },
            qb = function(a) {
              var b = B(),
              ...
              return (
                f && (e || (d && Ma.vars.suppressClickOnDrag !== !1)) && a.stopImmediatePropagation(),
                !c || (Ma.pointerEvent && Ma.pointerEvent.defaultPrevented) || (e && i === h)
                  ? void (
                      (Ma.isPressed || d || c) &&
                      (f
                        ? (i && a.detail && c && !g) ||
          ...
          (da = Ta.get(this.target)),
            ...
            (this.getDirection = function(a, b) {
              var c,
                ...
                h,
                i,
                j = 'velocity' === a && f ? a : 'object' != typeof a || za ? 'start' : 'element';
              return (
                'element' === j && ((h = Xa(Ma.target)), (i = Xa(a))),
                (c =
                  'start' === j
                    ? Ma.x - l
                    : 'velocity' === j
              ...
              if ((ab(!0), bb(), s)) {
                if (
                  ...
                  (Ma.x !== b || Ma.y !== c) &&
                    ((e = !0),
                    (Ma.x = Ma.endX = b),
                    za ? (Ma.endRotation = b) : (Ma.y = Ma.endY = c),
                    (ba = !0),
                    _a(!0),
                    Ma.autoScroll && !Ma.isDragging))
                )
                  for (
                    $(d.parentNode),
                      f = d,
                    ...
                    (i = Y(f.parentNode)),
                      (h = i ? M : f.parentNode),
                      Fa && h.scrollTop > h._gsMaxScrollY && (h.scrollTop = h._gsMaxScrollY),
                      Ea && h.scrollLeft > h._gsMaxScrollX && (h.scrollLeft = h._gsMaxScrollX),
                      (f = h);
            ...
            (this.update = function(a, b, c) {
              ...
              return (
                fb(!b),
                a ? Ma.applyBounds() : (ba && c && _a(!0), ab(!0)),
                b && (nb(Ma.pointerX, Ma.pointerY), ba && _a(!0)),
                Ma.isPressed &&
                  !b &&
                  ((Ea && Math.abs(e - Ma.x) > 0.01) || (Fa && Math.abs(f - Ma.y) > 0.01 && !za)) &&
                  gb(),
                Ma.autoScroll && ($(d.parentNode), (Wa = Ma.isDragging), _a(!0)),
                Ma.autoScroll && (X(d, pb), W(d, pb)),
                Ma
              );
            }),
              ...
              if ('soft' !== a) {
                for (j = Ra.length; --j > -1; )
                  (k = Ra[j]),
                    ...
                    Ja(k, 'touchstart', lb),
                    Ja(k, 'click', qb, !0),
                    za || ca(k, 'cursor', g.cursor || 'move'),
                    ca(k, 'touchCallout', 'none'),
                    ca(k, 'touchAction', Ea === Fa ? 'none' : Ea ? 'pan-y' : 'pan-x'),
                    ta(k) && ca(k.ownerSVGElement || k, 'touchAction', Ea === Fa ? 'none' : Ea ? 'pan-y' : 'pan-x'),
                    this.vars.allowContextMenu || Ja(k, 'contextmenu', $a);
                Qa(Ra, !1);
              }
              return (
                W(d, pb),
                (h = !0),
                f && 'soft' !== a && f.track(i || d, ya ? 'x,y' : za ? 'rotation' : 'top,left'),
                i && i.enable(),
                (d._gsDragID = e = 'd' + G++),
                (F[e] = this),
            ...
            (this.disable = function(a) {
              var b,
                c,
                e = Ma.isDragging;
              if (!za) for (b = Ra.length; --b > -1; ) ca(Ra[b], 'cursor', null);
              if ('soft' !== a) {
                for (b = Ra.length; --b > -1; )
                  (c = Ra[b]),
                    ...
                    Ka(c, 'contextmenu', $a);
                Qa(Ra, !0),
                  la && (Ka(la, 'touchcancel', ob), Ka(la, 'touchend', ob), Ka(la, 'touchmove', mb)),
                  Ka(t, 'mouseup', ob),
                  Ka(t, 'mousemove', mb);
              }
              return (
                X(d, pb),
                (h = !1),
                f && 'soft' !== a && f.untrack(i || d, ya ? 'x,y' : za ? 'rotation' : 'top,left'),
                i && i.disable(),
                R(_a),
                (Ma.isDragging = Ma.isPressed = ha = !1),
                e && ja(Ma, 'dragend', 'onDragEnd'),
                Ma
              );
            }),
            ...
            -1 !== xa.indexOf('scroll') &&
              ...
              (d.style.overflowY = Fa && !Ha ? 'auto' : 'hidden'),
              (d.style.overflowX = Ea && !Ha ? 'auto' : 'hidden'),
              (d = i.content)),
            g.force3D !== !1 && b.set(d, { force3D: !0 }),
            za ? (Ua.rotation = 1) : (Ea && (Ua[Aa] = 1), Fa && (Ua[Da] = 1)),
            za
              ? ((P = p), (S = P.css), (P.overwrite = !1))
              : ya && ((P = Ea && Fa ? m : Ea ? n : o), (S = P.css), (P.overwrite = !1)),
            this.enable();
        },
        Ua = (Ta.prototype = new a());
      (Ua.constructor = Ta),
        (Ua.pointerX = Ua.pointerY = Ua.startX = Ua.startY = Ua.deltaX = Ua.deltaY = 0),
        ...
        (Ta.create = function(a, c) {
          'string' == typeof a && (a = b.selector(a));
          for (var d = a && 0 !== a.length ? (Fa(a) ? Ga(a) : [a]) : [], e = d.length; --e > -1; )
            d[e] = new Ta(d[e], c);
          return d;
        }),
        (Ta.get = function(a) {
      ...
      var Va = {},
        ...
        Xa = function(a, b) {
          if (a === window)
            return (
              (Va.left = Va.top = 0),
              (Va.width = Va.right = u.clientWidth || a.innerWidth || t.body.clientWidth || 0),
              (Va.height = Va.bottom =
                (a.innerHeight || 0) - 20 < u.clientHeight
                  ? u.clientHeight
                  : a.innerHeight || t.body.clientHeight || 0),
          ...
          return i || !c
            ...
            : ((f = -1 !== (c + '').indexOf('%')),
              ...
              d.width < 0 || d.height < 0
                ? !1
                : f
                ? ((c *= 0.01), (e = d.width * d.height), e >= g.width * g.height * c || e >= h.width * h.height * c)
                : d.width > c && d.height > c);
        }),
        (D.style.cssText = 'visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;'),
        Ta
      );
    },
    !0
  ...
  (function(a) {
    ...
    'undefined' != typeof module && module.exports
      ? (require('../TweenLite.min.js'), require('../plugins/CSSPlugin.min.js'), (module.exports = b()))
      : 'function' == typeof define && define.amd && define(['TweenLite', 'CSSPlugin'], b);
  })('Draggable');
