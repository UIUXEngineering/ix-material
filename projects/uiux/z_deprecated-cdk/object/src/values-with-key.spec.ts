...
import { valuesWithKey } from './values-with-key';
...
describe('isObject', () => {
  ...
  it('should add named key to object and convert to array', () => {
  ...
  it('should return array without key if key is null', () => {
  ...
  it('should return array without key if key is undefined', () => {
