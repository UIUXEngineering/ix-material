...
describe('mergeIn', () => {
  ...
  describe('works like merge', () => {
    ...
    it('should be recursive', () => {
      ...
      const result: any = mergeIn(target, null, source);
    ...
    it('should update boolean true', () => {
      ...
      expect(mergeIn(obj1, null, obj2).foo).toBeTruthy();
      expect(mergeIn(obj1, null, obj2).bar).toBeTruthy();
    });
    ...
    it('should update boolean false', () => {
      ...
      expect(mergeIn(obj1, null, obj2).bar).toBeFalsy();
    });
