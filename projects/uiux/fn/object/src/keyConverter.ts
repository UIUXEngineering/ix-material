...
import { isArray, map, hasValue } from '@uiux/fn/common';
import { isArrayInteger } from '@uiux/fn/number';
 ...
 */
export function getIndexAsNumber(key: string): number {
