...
describe('allValuesDefined', () => {
  ...
  describe('object with multiple props', () => {
    it('should return false for object with false prop', () => {
      ...
      expect(allValuesDefined(obj)).toBeTruthy();
    });
    ...
    it('should return false for object with null prop', () => {
      ...
      expect(allValuesDefined(obj)).toBeFalsy();
    });
  ...
  describe('object', () => {
    it('should return false for empty object value', () => {
      expect(allValuesDefined({})).toBeFalsy();
    });
  ...
  describe('subKey', () => {
    it('should have value for all subkeys', () => {
      ...
      expect(allValuesDefined(obj, 'x')).toBe(true);
    });
    ...
    it('should be false for empty object subkeys', () => {
      ...
      expect(allValuesDefined(obj, 'x.y')).toBe(false);
    });
  ...
  describe('functions', () => {
    it('should call function to return value subkeys', () => {
      ...
      expect(
        allValuesDefined(obj, 'x.y', (val: any) => {
    ...
    it('should call function to return value subkeys', () => {
      ...
      const fn: predicateFn = (val: any) => {
        return isDefined(val.call());
      };

      expect(allValuesDefined(obj, 'x.y', fn)).toBe(true);
    });
    ...
    it('should call function to return value subkeys', () => {
      ...
      expect(allValuesDefined(obj, 'x.y', fn, this)).toBe(true);
    });
    ...
    it('should call function to return value subkeys', () => {
      ...
      expect(allValuesDefined(obj, 'x.y', fn)).toBe(false);
    });
  ...
  describe('empty value', () => {
    ...
    it('should return false for null value', () => {
      expect(allValuesDefined(null)).toBeFalsy();
    });

    it('should return false for undefined value', () => {
      expect(allValuesDefined(undefined)).toBeFalsy();
    });
