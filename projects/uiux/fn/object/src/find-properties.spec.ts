...
import { isTruthy } from '@uiux/fn/value';
...
describe('findProperties', () => {
  ...
  describe('function', () => {
    it('should find using conditions on props', () => {
      const testFn: Function = (item: any) => {
        return propsHaveValue(item, ['a', 'b']);
      };
    ...
    it('should find using conditions on props', () => {
      const testFn: Function = (item: any) => {
        return propsHaveValue(item, ['a', 'b']) && isTruthy(item.a);
      };
    ...
    it('should find using conditions on props', () => {
      const testFn: Function = (item: any, key: string) => {
        return key === 'ttt' && propsHaveValue(item, ['a', 'b']) && isTruthy(item.a);
      };
