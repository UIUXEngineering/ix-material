...
//     fixture.detectChanges();
//
//     const items = Array.from(overlayContainerElement.querySelectorAll('.ix-menu-item'));
//
...
//       fixture.componentInstance.trigger.openMenu();
//       fixture.detectChanges();
//     }).toThrowError(/must pass in an ix-menu instance/);
//   });
//
...
//
//     const panel = overlayContainerElement.querySelector('.ix-menu-panel')!;
//     const items = Array.from(panel.querySelectorAll('.ix-menu-item')) as HTMLElement[];
...
//       [ixMenuTriggerRestoreFocus]="restoreFocus"
...
// })
// class SimpleMenu {
//   @ViewChild(IxMenuTrigger, {static: false}) trigger: IxMenuTrigger;
//   @ViewChild('triggerEl', {static: false}) triggerEl: ElementRef<HTMLElement>;
//   @ViewChild(IxMenu, {static: false}) menu: IxMenu;
...
// })
// class NestedMenu {
//   @ViewChild('root', {static: false}) rootMenu: IxMenu;
//   @ViewChild('rootTrigger', {static: false}) rootTrigger: IxMenuTrigger;
//   @ViewChild('rootTriggerEl', {static: false}) rootTriggerEl: ElementRef<HTMLElement>;
//   @ViewChild('alternateTrigger', {static: false}) alternateTrigger: IxMenuTrigger;
//   readonly rootCloseCallback = jasmine.createSpy('root menu closed callback');
//
//   @ViewChild('levelOne', {static: false}) levelOneMenu: IxMenu;
//   @ViewChild('levelOneTrigger', {static: false}) levelOneTrigger: IxMenuTrigger;
//   readonly levelOneCloseCallback = jasmine.createSpy('level one menu closed callback');
//
//   @ViewChild('levelTwo', {static: false}) levelTwoMenu: IxMenu;
//   @ViewChild('levelTwoTrigger', {static: false}) levelTwoTrigger: IxMenuTrigger;
//   readonly levelTwoCloseCallback = jasmine.createSpy('level one menu closed callback');
//
//   @ViewChild('lazy', {static: false}) lazyMenu: IxMenu;
//   @ViewChild('lazyTrigger', {static: false}) lazyTrigger: IxMenuTrigger;
//   showLazy = false;
// }
//
// @Component({
...
//   @ViewChild('triggerOne', {static: false}) triggerOne: IxMenuTrigger;
//   @ViewChild('triggerTwo', {static: false}) triggerTwo: IxMenuTrigger;
// }
//
//
//
// @Component({
//   template: `
//     <button [ixMenuTriggerFor]="one">Toggle menu</button>
//     <ix-menu #one="ixMenu">
//       <button ix-menu-item>One</button>
//     </ix-menu>
//
//     <ix-menu #two="ixMenu">
//       <button ix-menu-item>Two</button>
...
//   @ViewChild(IxMenuTrigger, {static: false}) trigger: IxMenuTrigger;
//   @ViewChild('one', {static: false}) firstMenu: IxMenu;
//   @ViewChild('two', {static: false}) secondMenu: IxMenu;
// }
//
//
// @Component({
...
//
//     <ix-menu #menu="ixMenu">
//       <button ix-menu-item role="menuitemcheckbox" aria-checked="true">Checked</button>
//       <button ix-menu-item role="menuitemcheckbox" aria-checked="false">Not checked</button>
//     </ix-menu>
//   `
// })
