...
describe('SpSearchAutoComplateFormGroupFactory', () => {
  ...
  it(
    'should return default error messages from errorsMessagesConfig',
    inject(
      [SpSearchAutoComplateFormGroupFactory],
      (service: SpSearchAutoComplateFormGroupFactory) => {
        const formGroup: SpSearchAutoComplateFormGroup = service.create();
  ...
  it(
    'should return search validators from validatorsConfig',
    inject(
      [SpSearchAutoComplateFormGroupFactory],
      (service: SpSearchAutoComplateFormGroupFactory) => {
        const formGroup: SpSearchAutoComplateFormGroup = service.create();
  ...
  it(
    'should return search as defaultValueConfig',
    inject(
      [SpSearchAutoComplateFormGroupFactory],
      (service: SpSearchAutoComplateFormGroupFactory) => {
        const formGroup: SpSearchAutoComplateFormGroup = service.create();
  ...
  it(
    'should create SpSearchAutoComplateFormGroup',
    inject(
      [SpSearchAutoComplateFormGroupFactory],
      (service: SpSearchAutoComplateFormGroupFactory) => {
        const formGroup: SpSearchAutoComplateFormGroup = service.create();
